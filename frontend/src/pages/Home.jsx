    ...
    return (
        <div className='w-full h-[100vh] bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex'>
            ...
            <div className='w-80 bg-black/20 backdrop-blur-sm border-r border-white/10 flex flex-col items-center p-6'>
                ...
                <h2 className='text-white text-xl font-bold mb-2'>{userData?.assistantName || 'Assistant'}</h2>
                <p className='text-gray-300 text-sm text-center mb-6'>Your AI Virtual Assistant</p>
